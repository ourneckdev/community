...
public interface IAddressRepository : IRepository
{
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    Task<UserAddress> GetUserAddressAsync(Guid addressId, Guid communityId, Guid userId, CancellationToken token = default);
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    Task<CommunityAddress> GetCommunityAddressAsync(Guid addressId, Guid communityId, CancellationToken token = default);
